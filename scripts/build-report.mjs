...
<section class="about"><h2>Claude 週報整合紀錄</h2><p>本期曾讀取：${esc(weeklyReportIntegration.title)}（私人歸檔不公開連結）</p><p>Drive 修改時間：${esc(weeklyReportIntegration.modifiedAt)}</p>${list(weeklyReportIntegration.adopted)}${list(weeklyReportIntegration.corrections)}<p>公開原始來源的核實紀錄見各篇；內部 WORK 責任、期限與完成證據不列入公開版。</p></section>
