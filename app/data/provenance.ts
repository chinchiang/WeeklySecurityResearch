...
export const sourceWorkflows = [
  { id: "claude-report", title: "Claude｜製造業資安觀測週報", schedule: "週二 15:00 · 臺北", role: "AI Security＋企業資安架構／產品安全兩部分各自選件、排序。Google Doc 歸檔於 Weekly Security Reports，PDF 在 Claude 對話交付。", handoff: "提供候選與分析 → 週五／週六依主題接手查核", evidence: "2026-09-13 使用者提供的排程設定；新版兩部分交付尚待首次執行。" },
  { id: "chatgpt-ai", title: "ChatGPT｜AI Security 技術研究簡報", schedule: "週五 08:00 · 臺北", role: "讀取 Claude 週報第一部分，查核原始研究並補充本週新證據；負責模型、Agent、AI 平台、AI 資料／IP 與評估方法。", handoff: "查核與去重 → AI 主題網站更新", evidence: "2026-09-12 有手動研究紀錄；到點自動觸發與新版接手流程尚待執行證據。" },
