...
export const sourceWorkflows = [
  { id: "claude-report", title: "Claude｜製造業資安觀測週報", schedule: "週二 15:00 · 臺北", role: "AI Security＋企業資安架構／產品安全兩部分各自選件、排序。Google Doc 歸檔於 Weekly Security Reports，PDF 在 Claude 對話交付。", handoff: "提供候選與分析 → 週五／週六依主題接手查核", evidence: "2026-09-18 已讀 W38 新版兩部分全文；來源修改時間 2026-09-15 15:23:10（臺北），report ID GSMD-WATCH-2026-0915-01。文件存在不等同排程觸發證明。" },
  { id: "chatgpt-ai", title: "ChatGPT｜AI Security 技術研究簡報", schedule: "週五 08:00 · 臺北", role: "讀取 Claude 週報第一部分，查核原始研究並補充本週新證據；負責模型、Agent、AI 平台、AI 資料／IP 與評估方法。", handoff: "查核與去重 → AI 主題網站更新", evidence: "2026-09-18 已完成 W38 第一部分接手與公開來源查核；研究／發布分開記錄於 public/reading-runs/2026-09-18-ai-w38.json。未取得可公開的排程觸發稽核證據，不標到點觸發已驗證。" },
  { id: "chatgpt-enterprise", title: "ChatGPT｜企業資安綜合閱讀清單", schedule: "週六 01:00 · 臺北", role: "讀取 Claude 週報第二部分，查核並補充企業架構、OT／ICS、產品安全、非 AI 專屬資料保護、AppSec、供應鏈與治理。", handoff: "查核與去重 → 企業資安主題網站更新", evidence: "2026-09-12 有手動研究紀錄；到點自動觸發與新版接手流程尚待執行證據。" },
] as const;
